 ...
 * 
 * show-off @method
 * @method \Base\Sql\CustomSelect addJoinColumns($name, $columns = self::SQL_STAR, $reset = false) Add join columns
 * @method \Base\Sql\CustomSelect limitPage($page = 0, $rowCount = 10) Sets the limit and count by page number
 */
