...
class AlterTable extends AbstractSql implements SqlInterface
{
    ...
    protected function processAddColumns(PlatformInterface $adapterPlatform)
    {
        $sqls = array();
    ...
    protected function processChangeColumns(PlatformInterface $adapterPlatform)
    {
        $sqls = array();
    ...
    protected function processDropColumns(PlatformInterface $adapterPlatform)
    {
        $sqls = array();
    ...
    protected function processAddConstraints(PlatformInterface $adapterPlatform)
    {
        $sqls = array();
    ...
    protected function processDropConstraints(PlatformInterface $adapterPlatform)
    {
        $sqls = array();
